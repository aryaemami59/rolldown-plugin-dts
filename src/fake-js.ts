 ...
 *
 * @param context - The Rolldown plugin context, used to resolve the `import()` type reference.
 * @param importer - The module ID of the declaration file being transformed, used as the importer when resolving the `import()` type reference.
