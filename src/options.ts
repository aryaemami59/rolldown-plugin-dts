 ...
 * @throws An {@linkcode Error} if incompatible options are combined (e.g. {@linkcode Options.tsgo | tsgo} with {@linkcode Options.vue | vue}, {@linkcode Options.oxc | oxc}, or {@linkcode Options.tsMacro | tsMacro}).
 */
